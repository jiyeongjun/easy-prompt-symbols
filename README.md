...
Claude Code에서 테스트할 때는 스킬 경로를 명시해서 사용할 수 있습니다.

```bash
claude -p \
  --add-dir "$HOME/.codex/skills/easy-prompt-symbols" \
  'Use the skill at ~/.codex/skills/easy-prompt-symbols/SKILL.md to turn this rough request into an easy symbol-based prompt:
